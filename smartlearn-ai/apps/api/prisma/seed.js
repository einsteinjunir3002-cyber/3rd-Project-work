...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var faculty, department, program, passwordHash, lecturer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Seeding database...');
                    return [4 /*yield*/, prisma.faculty.upsert({
                            where: { code: 'FOC' },
                            update: {},
                            create: {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.user.upsert({
                            where: { email: 'lecturer@smartlearn.edu' },
                            update: {},
                            create: {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, prisma.course.upsert({
                            ...
                            create: {
                                ...
                                description: 'Learn the fundamentals of Python and algorithmic thinking.',
                                credits: 3,
