  ...
  function extend() {
    ...
    if (!appState.demoPlagiarismReports) {
      appState.demoPlagiarismReports = [
        ...
        { documentName: 'Malaria_Prevalence_Study_Draft.txt', analysisDate: 'June 10, 2026', wordCount: 650, overallSimilarity: 52, aiGeneratedLikelihood: 75, recommendation: 'FLAG_CONCERN', matches: [{ source: 'Research Paper — Socio-Economic Mobile Money Study', combinedSimilarity: 40, matchType: 'similar_topic', sourceType: 'Published Repository', excerpt: '"...mobile money adoption correlates strongly with..."' }], missingCitations: ['No References/Bibliography section detected'], aiIndicators: ['it is worth noting that', 'in the realm of', 'plays a pivotal role'] },
        { documentName: 'Solar_Microgrid_Optimization_Proposal.pdf', analysisDate: 'June 08, 2026', wordCount: 1240, overallSimilarity: 22, aiGeneratedLikelihood: 12, recommendation: 'CLEAR', matches: [{ source: 'UENR Thesis Extract [DEMO] — Renewable Energy', combinedSimilarity: 22, matchType: 'similar_topic', sourceType: 'Published Repository', excerpt: '"...technical and economic viability of deploying off-grid solar..."' }], missingCitations: [], aiIndicators: [] }
      ];
    }
  }
  extend();
